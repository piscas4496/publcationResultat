  	...
  	echo $error="";
           ...
           $Password =htmlspecialchars($_POST['password']);               
 	  		if (isset($Email) AND isset($Password)) {
                  ...
                  $req=$bd->prepare("SELECT * FROM admin WHERE  pseudo=? AND password=?");	
 	 	  		   $req->execute(array($Email,$Password));
 	 	  		   $etudexist=$req->rowCount();
           					if ($etudexist ==1) {
           				$affichage = $req->fetch();
           				   $_SESSION['codadmin'] = $affichage['codadmin'];
           					$_SESSION["pseudo"]=$affichage['pseudo'];
           				                    
		header("Location:../admin/resultat.php?codadmin=".$_SESSION['codadmin']);				 				 
	...
	<div class="container"  align="center">
		<form id="formul" method="POST" align="center">
		   ...
		   <img id="images" src="../images/2044908.jpg">
		        ...
		        <input type="text" name="pseudo" class="for-control"><br>
				</div>
