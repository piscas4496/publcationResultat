 ...
 include("../partie/header.php"); 
  if (isset($_POST['connexion'])) { 
  	echo $error="";
		...
		header("Location:../formulaires/profil.php?idetudiant=".$_SESSION['idetudiant']);				 				 
...
<body >
	<div class="container"  align="center">
		...
		<form id="formul" method="POST" align="center" class="jumbotron">
			<h5>connexion des étudiants</h5> 
			<div class="">
		   <img id="images" src="../images/Student Male_96px.PNG">
